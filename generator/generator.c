...
//a voir l'encapsulation 
//un variable global qui est precedé par mot static ca reste toujours global mais 
//on private la propreté que la variable est globale c'est de l'encapsulation 
